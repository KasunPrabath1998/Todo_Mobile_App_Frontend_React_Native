...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, Image, Animated, ActivityIndicator, Dimensions, Alert } from 'react-native';
...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await axios.post('http://54.237.53.166:3001/api/auth/login', {
        email,  
        password,
      });
