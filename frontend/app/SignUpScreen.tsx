...
const SignUpScreen = () => {
  ...
  const [request, response, promptAsync] = useAuthRequest({
    clientId: '642181976671-q1gu7a1omr4k0ohavd2s6ftd83f1ssti.apps.googleusercontent.com',
    scopes: ['profile', 'email'],
    redirectUri: 'http://54.237.53.166:3001/redirect',
  }, {
  ...
  useEffect(() => {
    if (response?.type === 'success') {
      ...
      axios.post('http://54.237.53.166:3001/google-signin', { id_token })
        .then((res) => {
          if (res.status === 200) {
  ...
  const handleSignUp = async () => {
    ...
    try {
      const response = await axios.post('http://54.237.53.166:3001/api/auth/signup', {
        fullName,
        email,
        mobileNumber,
        password,
